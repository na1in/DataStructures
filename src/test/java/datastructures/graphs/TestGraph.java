...
public class TestGraph extends BaseTest {
    ...
    void tesAddEdgeExceptions() {
        ...
        IList<SimpleEdge<String>> edges = new DoubleLinkedList<>();
        edges.add(edge("a", "b", 2));
        edges.add(edge("d","e",2));

        assertThrows(IllegalArgumentException.class, () -> buildGraphWithData(vertices,edges));
    ...
    void testFindMstSimple2() {
        ...
        IList<SimpleEdge<String>> edges = new DoubleLinkedList<>();
        edges.add(edge("a", "b", 2)); // id: 0
        edges.add(edge("b", "c", 5)); // id: 1
        edges.add(edge("c", "d", 6)); // id: 2
        edges.add(edge("d", "e", 7)); // id: 3
        edges.add(edge("e", "a", 1)); // id: 4
        edges.add(edge("a", "f", 4)); // id: 5
        ...
        assertThat(mst, is(setContaining(0, 1, 2, 4, 5)));
    }

    @Test
    void testFindMstSimple3() {
        IList<String> vertices = new DoubleLinkedList<>();
        vertices.add("a");
        vertices.add("b");
        vertices.add("c");
        ...
        IList<SimpleEdge<String>> edges = new DoubleLinkedList<>();
        edges.add(edge("a", "b", 10)); // id: 0
        edges.add(edge("a", "c", 12)); // id: 1
        edges.add(edge("b", "c", 9)); // id: 2
        edges.add(edge("b", "d", 8)); // id: 3
        edges.add(edge("c", "e", 3)); // id: 4
        edges.add(edge("c", "f", 1)); // id: 5
        edges.add(edge("e", "d", 7)); // id: 6
        edges.add(edge("e", "f", 3)); // id: 7
        edges.add(edge("d", "f", 9)); // id: 8
        edges.add(edge("d", "g", 8)); // id: 9
        edges.add(edge("d", "h", 5)); // id: 10
        edges.add(edge("f", "h", 6)); // id: 11
        edges.add(edge("g", "h", 9)); // id: 12
        edges.add(edge("g", "i", 2)); // id: 13
        edges.add(edge("h", "i", 11)); // id: 14
        ...
        assertThat(mst, is(setContaining(0, 3, 4, 5, 9, 10, 11, 13)));
    }


    @Test
    void testFindMstSimple4() {
        IList<String> vertices = new DoubleLinkedList<>();
        vertices.add("a");
        vertices.add("b");
        vertices.add("c");
        ...
        IList<SimpleEdge<String>> edges = new DoubleLinkedList<>();
        edges.add(edge("a", "b", 1)); // id: 0
        edges.add(edge("a", "c", 1)); // id: 1
        edges.add(edge("b", "c", 3)); // id: 2
        edges.add(edge("b", "d", 2)); // id: 3
        edges.add(edge("b", "e", 2)); // id: 4
        edges.add(edge("e", "c", 1)); // id: 5
        edges.add(edge("e", "f", 4)); // id: 6
        edges.add(edge("d", "e", 1)); // id: 7
        ...
        assertThat(mst, is(setContaining(0, 1, 5, 6, 7)));
    }
    ...
    void testFindShortestPathException(){
        ...
        assertThrows(IllegalArgumentException.class, () -> graph.findShortestPathBetween("g","a"));
