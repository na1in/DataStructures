...
import datastructures.priorityqueues.InvalidElementException;
...
public class TestArrayDisjointSets extends BaseTest {
    ...
    void testUnionSimple2() {
        ...
        int id3 = disjointSets.findSet("e");
        assertThat(id3, either(is(4)).or(is(5)));
        assertThat(disjointSets.findSet("e"), is(id3));
    }
    @Test
    ...
    @Test
    void testMakeSetExceptions() {
        String[] items = new String[] {"a", "b", "c", "d", "e"};
        IDisjointSets<String> disjointSets = createDisjointSets(items);
        assertThrows(IllegalArgumentException.class, () -> disjointSets.makeSet("a"));
    }

    @Test
    void testFindSetExceptions() {
        String[] items = new String[] {"a", "b", "c", "d", "e"};
        IDisjointSets<String> disjointSets = createDisjointSets(items);
        assertThrows(IllegalArgumentException.class, () -> disjointSets.findSet("g"));
    }

    @Test
    void testUnionSetExceptions() {
        String[] items = new String[] {"a", "b", "c", "d", "e"};
        IDisjointSets<String> disjointSets = createDisjointSets(items);
        assertThrows(IllegalArgumentException.class, () -> disjointSets.union("g","a"));
        assertThrows(IllegalArgumentException.class, () -> disjointSets.union("a","g"));
    }
}
